...
EVM Storage & N/A & Verification Keys & \textbf{32 Bytes} \\
Proving Latency & 12--36 s & 10--300 s & \textbf{< 1 ms} \\
Verification Gas & $\sim$60,000 & $\sim$380,000 & \textbf{21,438} \\
Intra-Block Revert & No & No & \textbf{Native} \\
Hardware Req. & Server Node & GPU Cluster & \textbf{None (EVM)} \\
Liveness Risk & Centralized & Prover Outage & \textbf{Zero} \\
\bottomrule
\end{tabular}
\end{table}
